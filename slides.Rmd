...
- 18.00 - 18.30: Live demo (see [demo.Rmd](https://github.com/sfnetworks/OGH2021/raw/master/demo.Rmd)) + Q&A + coding the solution to the challenge for OGH 2021
...
plot(pois, pch = 8, cex = 2, lwd = 3, add = TRUE) #BREAK
plot(net, cex = 2, lwd = 4) #BREAK
plot(snapped_pois, pch = 8, cex = 3, lwd = 3, add = TRUE)
```
